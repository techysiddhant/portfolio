        ...
        <div className="grid gird-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8">
          <Card className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2">
            ...
            <div className="relative flex-1">
              {
                hobbies.map((hobby) => (
                  <div key={hobby.title} style={{ left: hobby.left, top: hobby.top }} className="absolute inline-flex items-center gap-2 px-6 bg-gradient-to-r from-emerald-300 to-sky-400 rounded-full py-1.5 "   >
